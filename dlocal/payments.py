...
from dlocal.models.payment_methods import PaymentMethodFlow
...
SECURE_PAYMENTS_URL = f'{BASE_URL}/secure-payments'
...
def create_payment(
        ...
        use_secure_url: bool = False,  # Only needed for payments made with credit card tokens
):
